    ...
    <div>
      <Container>
        <Row>
                ...
                <Card>
                  <Card.Header className="bg-white">
                    <div className="d-flex justify-content-between align-items-start">
                      <div>
                        <Card.Title><h1 className="fw-bold">{data.data.city.name}</h1></Card.Title>
                        <Card.Text>{data.data.city.country
                          + " |  lat:" + data.data.city.coord.lat + ", lon:" + data.data.city.coord.lon}
                        </Card.Text>
                      </div>
                      <div className="d-flex justify-content-between align-items-start">
                        <div className="ms-0 text-center">
                          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-brightness-alt-high" viewBox="0 0 16 16">
                            <path d="M8 3a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 3zm8 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zm-13.5.5a.5.5 0 0 0 0-1h-2a.5.5 0 0 0 0 1h2zm11.157-6.157a.5.5 0 0 1 0 .707l-1.414 1.414a.5.5 0 1 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm-9.9 2.121a.5.5 0 0 0 .707-.707L3.05 5.343a.5.5 0 1 0-.707.707l1.414 1.414zM8 7a4 4 0 0 0-4 4 .5.5 0 0 0 .5.5h7a.5.5 0 0 0 .5-.5 4 4 0 0 0-4-4zm0 1a3 3 0 0 1 2.959 2.5H5.04A3 3 0 0 1 8 8z" />
                          </svg>
                          <Card.Text className="text-center">Sunrise<br />{new Date(data.data.city.sunrise * 1000).toLocaleTimeString("en-US")}</Card.Text>
                        </div>
                        <div className="ms-4 text-center">
                          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-cloud-moon" viewBox="0 0 16 16">
                          ...
                          <Card.Text className="text-center">Sunset<br />{new Date(data.data.city.sunset * 1000).toLocaleTimeString("en-US")}</Card.Text>
                        </div>
                      </div>
                    </div>
                  </Card.Header>
                          ...
                          <Accordion.Item eventKey={y} key={y}>
                            <Accordion.Header>
                              <h5 className="fw-bold">
                                {
                                  new Date(y).getDate() === new Date().getDate() ? <>{"Today : " + y}</> : y
                                }
                              </h5>
                            </Accordion.Header>
                            <Accordion.Body>
                                  ...
                                  filterList[y].map((x, i) =>
                                    ...
                                    >
                                      <div>
                                        {
                                          x.weather[0].id === 800 ?
                                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-brightness-high" viewBox="0 0 16 16">
                                            ...
                                            : x.weather[0].id === 801 ?
                                              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-cloudy" viewBox="0 0 16 16">
                                              ...
                                              : x.weather[0].id === 803 ?
                                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-clouds" viewBox="0 0 16 16">
                                                ...
                                                : x.weather[0].id === 804 ?
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-clouds-fill" viewBox="0 0 16 16">
                                                  ...
                                                  : x.weather[0].id === 802 ?
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-cloud-sun" viewBox="0 0 16 16">
                                      ...
                                      <div className="ms-3 me-auto">
                                        <Card.Title className="fw-bold mb-1">{new Date(x.dt_txt).toLocaleTimeString()}</Card.Title>
                                        <Card.Text className="mb-1 text-capitalize">{x.weather[0].description + ", " + x.weather[0].id}</Card.Text>
                                        <Badge pill bg="light" text="dark" className="m-1 border border-dark">{"Pressure: " + x.main.pressure}</Badge>
                                        <Badge pill bg="light" text="dark" className="m-1 border border-dark">{"Humidity: " + x.main.humidity}</Badge>
                                        <Badge pill bg="light" text="dark" className="m-1 border border-dark">{"Temp: " + x.main.temp}</Badge>
                                        <Badge pill bg="light" text="dark" className="m-1 border border-dark">{"Visibility: " + x.visibility}</Badge>
                                      </div>
                                    </ListGroup.Item>
                                  )
                                }
          ...
          <Button variant="light" className="getPosBtn"
            onClick={() => getPosition()}>
